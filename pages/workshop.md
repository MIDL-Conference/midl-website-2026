...
Finally, we will explore **Isaac For Healthcare**, demonstrating how open data models, physics-based environments, and real-time sensor fusion support both healthcare robotics and simulation. These capabilities can be used to train and evaluate autonomous or semi-autonomous surgical systems. Example projects and code will be provided, and parallel lectures and lab sessions will ensure participants gain both conceptual insights and practical experience.  
